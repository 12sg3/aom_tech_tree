...
for img in images_to_text_entries_minor_gods:
    ...
    basic_description = get_description_from_img_tech(img_file_name, f'{dir_path_minor_gods}{img_file_name.replace('_', ' ')}')
    ...
    if img_name in names:
        ...
        data_df.loc[data_df[NAME] == img_name, TYPE] = MINOR_GOD

    else:
        new_df_entries.append(pandas.DataFrame([{NAME: img_name, DESCRIPTION: basic_description, TYPE: MINOR_GOD}]))
