...
export class Lane {
    ...
    updatePositions(offsets_y, element_length) {
        ...
        for (let connection of connections) {
            ...
            let allRelevantTosXval = allRelevantTos.map(to_ => carets.get(to_).x);
...
export function getName(obj_name_id) {
...
export function building(obj_name_id) {
...
export function unit(obj_name_id) {
...
export function minor_god(obj_name_id) {
...
export function god_power(obj_name_id) {
...
export function bushido_god_blessing(obj_name_id) {
    // console.log('God Power - obj_name_id: ', obj_name_id);
    // console.log('obj_name_id.id: ', obj_name_id.id);
    // console.log("getName(obj_name_id, 'units'): ",getName(obj_name_id, 'units'));
