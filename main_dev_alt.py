...
ATTACK_TYPES_TO_IGNORE_RECHARGE = ['HandAttack', 'RangedAttack', 'RangedAttackFlying', 'AntiWallAttack', 'Pickup,', 'DropOff', 'AreaHeal', 'Heal', 'Lifesteal', 'AreaAttack', 'LightningAttack', 'FlyingUnitAttack', 'DelayedTransformZhuqueLand', 'HandAttackLand', 'ChargedModify', 'JumpAttackStealth']
