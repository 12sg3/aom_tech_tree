...
class Tree {
    constructor() {
        this.offsets = {
            archaic_1_y: 0, // Aztec 3 icons
            archaic_2_y: 0, // Japense 3 icons
            classical_1_y: 0, // Chinese 3 icons  
            classical_2_y: 0, // Greeks 4 icons
            heroic_1_y: 0, // Egyptian 3 icons
            heroic_2_y: 0, // Norse 4 icons
            heroic_3_y: 0, // Atlantean 3 icons
            mythic_1_y: 0,
            mythic_2_y: 0,
        };
        this.padding = 20; //20
