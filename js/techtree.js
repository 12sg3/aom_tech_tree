...
SLIENT_RESOLVE = {id: 698, name: 'SLIENT_RESOLVE', type: 'tech'};
SLINGS_OF_THE_SUN = {id: 699, name: 'SLINGS_OF_THE_SUN', type: 'tech'};
SOJUTSU = {id: 700, name: 'SOJUTSU', type: 'tech'};
SOLAR_BARQUE = {id: 701, name: 'SOLAR_BARQUE', type: 'tech'};
SON_OF_LOONG = {id: 702, name: 'SON_OF_LOONG', type: 'tech'};
SONG_OF_MIDSUMMER = {id: 703, name: 'SONG_OF_MIDSUMMER', type: 'tech'};
SONS_OF_THE_SUN = {id: 704, name: 'SONS_OF_THE_SUN', type: 'tech'};
SONS_SLEIPNIR = {id: 705, name: 'SONS_SLEIPNIR', type: 'tech'};
SOUTHERN_FIRE = {id: 706, name: 'SOUTHERN_FIRE', type: 'tech'};
SPEAR_OF_HORUS = {id: 707, name: 'SPEAR_OF_HORUS', type: 'tech'};
SPIRIT_OF_MAAT = {id: 708, name: 'SPIRIT_OF_MAAT', type: 'tech'};
SPIRITED_CHARGE = {id: 709, name: 'SPIRITED_CHARGE', type: 'tech'};
SPOILS_OF_WAR = {id: 710, name: 'SPOILS_OF_WAR', type: 'tech'};
STONE_WALL_ATLANTEAN = {id: 711, name: 'STONE_WALL_ATLANTEAN', type: 'tech'};
STONE_WALL_EGYPTIAN = {id: 712, name: 'STONE_WALL_EGYPTIAN', type: 'tech'};
STONE_WALL_GREEK = {id: 713, name: 'STONE_WALL_GREEK', type: 'tech'};
STONE_WALL_NORSE = {id: 714, name: 'STONE_WALL_NORSE', type: 'tech'};
SUMO_TRAINING = {id: 715, name: 'SUMO_TRAINING', type: 'tech'};
SUN_DRIED_MUD_BRICK = {id: 716, name: 'SUN_DRIED_MUD_BRICK', type: 'tech'};
SUN_RAY = {id: 717, name: 'SUN_RAY', type: 'tech'};
SURVIVAL_EQUIPMENT = {id: 718, name: 'SURVIVAL_EQUIPMENT', type: 'tech'};
SWINE_ARRAY = {id: 719, name: 'SWINE_ARRAY', type: 'tech'};
SYLVAN_LORE = {id: 720, name: 'SYLVAN_LORE', type: 'tech'};
TAI_CHI = {id: 721, name: 'TAI_CHI', type: 'tech'};
TAX_COLLECTORS = {id: 722, name: 'TAX_COLLECTORS', type: 'tech'};
TEMPESTUOUS_STORM = {id: 723, name: 'TEMPESTUOUS_STORM', type: 'tech'};
TEMPLE_OF_HEALING = {id: 724, name: 'TEMPLE_OF_HEALING', type: 'tech'};
TENSHU = {id: 725, name: 'TENSHU', type: 'tech'};
TEN_FIST_SWORD = {id: 726, name: 'TEN-FIST_SWORD', type: 'tech'};
THEIA = {id: 727, name: 'THEIA', type: 'tech'};
THRACIAN_HORSES = {id: 728, name: 'THRACIAN_HORSES', type: 'tech'};
THUNDERING_HOOVES = {id: 729, name: 'THUNDERING_HOOVES', type: 'tech'};
THUNDEROUS_PRESENCE = {id: 730, name: 'THUNDEROUS_PRESENCE', type: 'tech'};
THURISAZ_RUNE = {id: 731, name: 'THURISAZ_RUNE', type: 'tech'};
TITAN_SHIELD = {id: 732, name: 'TITAN_SHIELD', type: 'tech'};
TITANOMACHY = {id: 733, name: 'TITANOMACHY', type: 'tech'};
TUSKS_OF_APEDEMAK = {id: 734, name: 'TUSKS_OF_APEDEMAK', type: 'tech'};
TWILIGHT_OF_THE_GODS = {id: 735, name: 'TWILIGHT_OF_THE_GODS', type: 'tech'};
VALGALDR = {id: 736, name: 'VALGALDR', type: 'tech'};
VALLEY_OF_THE_KINGS = {id: 737, name: 'VALLEY_OF_THE_KINGS', type: 'tech'};
VAULTS_OF_EREBUS = {id: 738, name: 'VAULTS_OF_EREBUS', type: 'tech'};
VIBRANT_LAND = {id: 739, name: 'VIBRANT_LAND', type: 'tech'};
VIKINGS = {id: 740, name: 'VIKINGS', type: 'tech'};
VOLCANIC_FORGE = {id: 741, name: 'VOLCANIC_FORGE', type: 'tech'};
WATCH_TOWER_GREEK = {id: 742, name: 'WATCH_TOWER_GREEK', type: 'tech'};
WATCH_TOWER = {id: 743, name: 'WATCH_TOWER', type: 'tech'};
WEIGHTLESS_MACE = {id: 744, name: 'WEIGHTLESS_MACE', type: 'tech'};
WILL_OF_KRONOS = {id: 745, name: 'WILL_OF_KRONOS', type: 'tech'};
WIND_SICKLES = {id: 746, name: 'WIND_SICKLES', type: 'tech'};
WINGED_MESSENGER = {id: 747, name: 'WINGED_MESSENGER', type: 'tech'};
WINTER_HARVEST = {id: 748, name: 'WINTER_HARVEST', type: 'tech'};
WISDOM_OF_NINE = {id: 749, name: 'WISDOM_OF_NINE', type: 'tech'};
WRATH_OF_THE_DEEP = {id: 750, name: 'WRATH_OF_THE_DEEP', type: 'tech'};
XUANYUANS_BLOODLINE = {id: 751, name: 'XUANYUANS_BLOODLINE', type: 'tech'};
YDALIR = {id: 752, name: 'YDALIR', type: 'tech'};
N_CHAMPION_INFANTRY_NORSE_LH = {id: 753, name: 'N_CHAMPION_INFANTRY_NORSE_LH', type: 'tech'};
N_HEAVY_INFANTRY_NORSE_LH = {id: 754, name: 'N_HEAVY_INFANTRY_NORSE_LH', type: 'tech'};
N_MEDIUM_INFANTRY_NORSE_LH = {id: 755, name: 'N_MEDIUM_INFANTRY_NORSE_LH', type: 'tech'};
...
function getDefaultTree() {
    ...
    // console.log('tree after oxCart: ', tree);
    ...
    dockLaneMatrix = [
        ...
        [], // heroic_3
        [JORMUN_ELVER, CONSCRIPT_SAILORS, CHAMPION_WARSHIP], // mythic_1
        [], // mythic_2
    ];
...
function getConnections() {
    ...
    let connectionsToAdd = [
        ...
        [HEAVY_WARSHIPS, CHAMPION_WARSHIP], //need to rename to CHAMPION_WARSHIPS
